                ...
                <div class="section-body">
                    ...
                    <div class="profile-info-wrapper">
                        <div class="avatar-outer">
                            <a href="{{ auth()->user()->foto ? asset('storage/' . auth()->user()->foto) : asset('sbadmin2/img/undraw_profile.svg') }}"
                                data-fancybox="profile" data-caption="{{ auth()->user()->name }}">
                    ...
                    <div class="action-group d-flex justify-content-center mt-5 gap-3">
                        <a href="{{ route('profile.edit') }}"
                            class="btn-elegant btn-primary-maroon text-decoration-none">
                        ...
                        <form method="POST" action="{{ route('logout') }}" id="logout-form">
                            @csrf
                            <button type="submit"
                                class="btn-elegant btn-outline-danger bg-white border-danger text-danger">
