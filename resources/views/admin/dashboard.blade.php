<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <button onclick="alert('Fitur laporan sedang disiapkan!')"
                class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold py-2 px-4 rounded shadow transition duration-200">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-blue-500 hover:shadow-md transition">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-xs text-green-600 mt-2 font-semibold"><i class="fas fa-check-circle"></i>
                                Status Aktif</p>
                        </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-purple-500 hover:shadow-md transition">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-xs text-purple-600 mt-2 font-semibold"><i class="fas fa-shield-alt"></i>
                                Otoritas Penuh</p>
                        </div>
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <h3 class="text-3xl font-bold text-gray-800 mt-1">
                                {{ \App\Models\User::where('created_at', '>=', now()->startOfMonth())->count() }}</h3>
                                ...
                                <table class="w-full text-sm text-left text-gray-500">
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        ...
                                        <tr class="hover:bg-gray-50/50 transition">
                                            ...
                                            <td class="px-4 py-4">
                                                <span
                                                    class="px-2 py-1 rounded text-[10px] font-extrabold tracking-tighter {{ $user->role == 'admin' ? 'bg-purple-100 text-purple-700 border border-purple-200' : 'bg-green-100 text-green-700 border border-green-200' }}">
                                            ...
                                            <td class="px-4 py-4 text-center">
                                                @if($user->id == 1)
                                                <span
                                                    class="text-[10px] bg-gray-800 text-white px-2 py-1 rounded shadow-sm inline-block">
                                                ...
                                                <div class="flex justify-center space-x-4">
                                                    <form action="{{ route('admin.users.updateRole', $user->id) }}"
                                                        ...
                                                        <button type="submit" title="Switch Role"
                                                    ...
                                                    <form action="{{ route('admin.users.destroy', $user->id) }}"
                                                        ...
                                                        <button type="submit" title="Hapus User"
                                                            class="text-red-400 hover:text-red-600 transition transform hover:scale-110">
                    ...
                    <div class="bg-indigo-600 p-6 rounded-xl shadow-lg text-white relative overflow-hidden">
                        <div class="relative z-10">
                            ...
                            <p class="text-xs leading-relaxed opacity-90">
                                Gunakan fitur pencarian untuk menemukan anggota berdasarkan nama atau email dengan
                                cepat. Perubahan role akan langsung berdampak pada akses menu user.
                            </p>
                        </div>
