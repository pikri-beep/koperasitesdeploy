    ...
    <div class="h-screen w-full flex items-center justify-center p-4">
        <div class="max-w-md w-full flex flex-col items-center">
            ...
            <div class="text-center mb-4">
                <div
                    class="inline-flex items-center justify-center w-12 h-12 bg-red-600 rounded-2xl shadow-lg mb-2 -rotate-3">
            ...
            <div
                class="bg-white rounded-[1.00rem] shadow-2xl p-6 border border-gray-100 relative w-full overflow-hidden">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-3">
                    ...
                    <div>
                        <label class="block text-[10px] font-black text-gray-400 uppercase mb-1 ml-1">Nama
                            Lengkap</label>
                        ...
                        @error('name') <p class="text-[9px] text-red-500 font-bold uppercase mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @error('email') <p class="text-[9px] text-red-500 font-bold uppercase mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <label
                                class="block text-[10px] font-black text-gray-400 uppercase mb-1 ml-1">Konfirmasi</label>
                    ...
                    <button type="submit"
                        class="w-full mt-2 bg-red-600 hover:bg-red-700 text-white font-black py-3.5 rounded-2xl shadow-xl shadow-red-200 transition transform active:scale-95 uppercase tracking-widest text-xs">
