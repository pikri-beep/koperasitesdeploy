    ...
    <div class="min-h-screen flex items-center justify-center p-4">
        <div class="max-w-md w-full">
            ...
            <div class="text-center mb-8">
                <div
                    class="inline-flex items-center justify-center w-16 h-16 bg-red-600 rounded-2xl shadow-lg mb-4 rotate-3">
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center justify-between mb-8 text-xs">
                        ...
                        <a href="{{ route('password.request') }}" class="text-red-600 hover:underline font-bold">Lupa
                            Sandi?</a>
                        @endif
                    </div>

                    <button type="submit"
                        class="w-full bg-red-600 hover:bg-red-700 text-white font-black py-4 rounded-2xl shadow-xl shadow-red-200 transition duration-300 transform active:scale-95 uppercase tracking-wider text-sm">
                ...
                <div class="mt-8 text-center border-t border-gray-50 pt-6">
                    <p class="text-sm text-gray-500 font-medium">
                        Belum jadi anggota?
                        <a href="{{ route('register') }}" class="text-red-600 font-black hover:underline ml-1">Daftar
                            Sekarang</a>
                    </p>
                </div>
            </div>
